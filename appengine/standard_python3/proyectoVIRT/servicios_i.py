...
<body>
    ...
    <div class="divtexto">
        <h1>Contando con un equipo siempre dispuesto a brindarles resultados de calidad.</h1>
    </div>
    <div class="space"></div>
    ...
    <div class="divtexto">
        <h1>Ofreciendo los siguientes servicios para todo el litoral atlántico latinoamericano.</h1>
    </div>
    <div class="space"></div>
